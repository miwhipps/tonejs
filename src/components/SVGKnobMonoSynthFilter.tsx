...
const SVGKnobMonoSynthFilter: React.FC<SvgKnobProps> = ({
  size = 100,
  value,
  onChange,
  sensitivity = 0.005,
  ...
  // ✅ move into render flow so it updates with value
  ...
  }, [dragging, value]); // ✅ include value here too
...
export default SVGKnobMonoSynthFilter;
